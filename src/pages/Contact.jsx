        ...
        <div className="grid grid-cols-1 lg:min-w-full lg:grid-cols-2 gap-4">
          ...
          >
            ...
            <button
              ...
              className={`cursor-pointer hover:bg-gradient-to-r from-cyan-600 via-sky-600 to-blue-500 flex gap-x-3 justify-center items-center w-full mt-2 rounded-lg border p-2 transition-all ${
